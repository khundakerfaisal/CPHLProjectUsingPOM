...
import approval.foreignPrApproval;
...
//    WebElement approveBySelect;
    ...
    public foreignPurchaseRequisition(WebDriver driver){
...
//        productQtyAdding.sendKeys(Keys.ENTER);
        ...
        pressOkButton.click();
        foreignPrApproval foreignpr=new foreignPrApproval(driver);
        foreignpr.foreignPrApprovalState();
        System.out.println("Foreign Purchase requsition Successfully Created!");
