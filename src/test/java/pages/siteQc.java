...
public class siteQc {
    ...
    public siteQc(WebDriver driver){
        PageFactory.initElements(driver,this);
    }

    public void siteQcCreate(WebDriver driver) throws InterruptedException {
        btnHomeMenu.click();
        Thread.sleep(1000);
        ...
        select.selectByVisibleText("Site Purchase");
        Thread.sleep(1000);
        ...
        Thread.sleep(1000);
        System.out.println("SITE QC Created Successfully");
