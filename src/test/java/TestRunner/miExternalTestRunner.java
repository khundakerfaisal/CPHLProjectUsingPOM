...
import pages.MRR;
import pages.miExternal;

public class miExternalTestRunner extends setupPage {
    @Test(priority = 1)
...
//        loginPage.doLogin(adminUser,adminPass);
    ...
    public void miExternalCreate() throws InterruptedException {
        miExternal miExternal=new miExternal(driver);
        miExternal.miExternalCreate(driver);
